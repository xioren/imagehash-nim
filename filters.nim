...
func filterGreyscalePIL*[T: ColorRGBAny](image: var Image[T]) =
  ## ITU-R BT.601
  for pixel in image.data.mitems:
    let c = (T.componentType) (pixel.r.precise * 299/1000 +
      pixel.g.precise * 587/1000 + pixel.b.precise * 114/1000)
    for i in colorIndexes T:
      pixel[i] = c
