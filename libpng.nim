...
type
  PngStruct = object
  PngInfo = object
  PngRWFn = proc(png: ptr PngStruct, outBytes: ptr uint8, count: csize_t)
...
proc png_get_bit_depth(png: ptr PngStruct, info: ptr PngInfo): uint8
proc png_get_color_type(png: ptr PngStruct, info: ptr PngInfo): uint8
...
proc png_read_image(png: ptr PngStruct, image: ptr ptr uint8)
proc png_write_image(png: ptr PngStruct, image: ptr ptr uint8)
...
proc pngReadString(png: ptr PngStruct, outBytes: ptr uint8, count: csize_t) =
  var reader = cast[ptr DataReader](png_get_io_ptr png)
  let address = cast[ptr uint8](cast[uint](reader.start) + reader.offset)
...
proc pngWriteBytes(png: ptr PngStruct, outBytes: ptr uint8, count: csize_t) =
